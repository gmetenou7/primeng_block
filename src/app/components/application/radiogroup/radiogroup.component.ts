...
<div class="surface-ground text-center px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="grid">
        <div class="col-12 lg:col-4">
            <div class="shadow-2 border-round border-2 cursor-pointer surface-card h-full" [ngClass]="{'border-transparent': hotel !== 0, 'border-blue-500': hotel === 0}" (click)="hotel = 0">
        ...
        <div class="col-12 lg:col-4">
            <div class="shadow-2 border-round border-2 cursor-pointer surface-card h-full" [ngClass]="{'border-transparent': hotel !== 1, 'border-blue-500': hotel === 1}" (click)="hotel = 1">
        ...
        <div class="col-12 lg:col-4">
            <div class="shadow-2 border-round border-2 cursor-pointer surface-card h-full" [ngClass]="{'border-transparent': hotel !== 2, 'border-blue-500': hotel === 2}" (click)="hotel = 2">
