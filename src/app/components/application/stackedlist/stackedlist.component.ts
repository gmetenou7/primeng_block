...
<div class="surface-card shadow-2 border-round p-4">
    ...
    <ul class="list-none p-0 m-0">
        <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between p-3 bg-yellow-50 border-1 border-yellow-500 mb-3" style="border-radius: 10px">
            <div>
                <div>
                    <span class="bg-white inline-flex justify-content-center align-items-center" style="border-radius: 9px; box-shadow: inset 0px 1px 2px rgba(100, 77, 18, 0.12); width: 2rem; height:2rem">
                        <i class="pi pi-file-o text-yellow-600"></i>
                    </span>
                    <span class="text-yellow-900 font-medium ml-2">Jenny Wilson</span>
                </div>
            ...
            <div class="flex align-items-center justify-content-between md:justify-content-end mt-3 md:mt-0">
                ...
                <div class="text-right ml-3">
                    <span class="text-yellow-900 font-medium">120.00</span>
                    <p class="mt-1 mb-0 text-yellow-700">EUR</p>
                </div>
            </div>
        </li>
        <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between p-3 bg-green-50 border-1 border-green-500 mb-3" style="border-radius: 10px">
            <div>
                <div>
                    <span class="bg-white inline-flex justify-content-center align-items-center" style="border-radius: 9px; box-shadow: inset 0px 1px 2px rgba(100, 77, 18, 0.12); width: 2rem; height:2rem">
                        <i class="pi pi-file-o text-green-600"></i>
                    </span>
                    <span class="text-green-900 font-medium ml-2">Dianne Russell</span>
                </div>
            ...
            <div class="flex align-items-center justify-content-between md:justify-content-end mt-3 md:mt-0">
                ...
                <div class="text-right ml-3">
                    <span class="text-green-900 font-medium">82.50</span>
        ...
        <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between p-3 bg-green-50 border-1 border-green-500 mb-3" style="border-radius: 10px">
            <div>
                <div>
                    ...
                    <span class="text-green-900 font-medium ml-2">Jerome Bell</span>
                </div>
            ...
            <div class="flex align-items-center justify-content-between md:justify-content-end mt-3 md:mt-0">
                <span class="bg-green-400 text-green-900 font-bold text-sm py-1 px-2" style="border-radius: 10px">PAID</span>
                <div class="text-right ml-3">
                    <span class="text-green-900 font-medium">250.00</span>
                    <p class="mt-1 mb-0 text-green-700">EUR</p>
                </div>
            </div>
        </li>
        <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between p-3 bg-pink-50 border-1 border-pink-500" style="border-radius: 10px">
            <div>
                <div>
                    <span class="bg-white inline-flex justify-content-center align-items-center" style="border-radius: 9px; box-shadow: inset 0px 1px 2px rgba(100, 77, 18, 0.12); width: 2rem; height:2rem">
                        <i class="pi pi-file-o text-pink-600"></i>
                    </span>
                    <span class="text-pink-900 font-medium ml-2">Courtney Henry</span>
                </div>
                <p class="text-pink-700 mt-2 mb-0">Due <span class="font-medium">01/05/2021</span></p>
            </div>
            <div class="flex align-items-center justify-content-between md:justify-content-end mt-3 md:mt-0">
                <span class="bg-pink-400 text-white font-bold text-sm py-1 px-2" style="border-radius: 10px">UNPAID</span>
                <div class="text-right ml-3">
                    <span class="text-pink-900 font-medium">60.00</span>
                    <p class="mt-1 mb-0 text-pink-700">EUR</p>
                </div>
            </div>
        </li>
    </ul>
    ...
    <ul class="list-none p-0 m-0">
        <li class="mb-4 border-bottom-1 surface-border py-3 flex flex-column md:flex-row md:align-items-center md:justify-content-between">
            <div class="inline-flex align-items-center">
                <img src="assets/images/blocks/logos/chrome.svg" class="mr-3" style="width: 32px; height: 32px" />
        ...
        <li class="mb-4 border-bottom-1 surface-border py-3 flex flex-column md:flex-row md:align-items-center md:justify-content-between">
            <div class="inline-flex align-items-center">
                <img src="assets/images/blocks/logos/firefox.svg" class="mr-3" style="width: 32px; height: 32px" />
        ...
        <li class="mb-4 border-bottom-1 surface-border py-3 flex flex-column md:flex-row md:align-items-center md:justify-content-between">
            <div class="inline-flex align-items-center">
                <img src="assets/images/blocks/logos/safari.svg" class="mr-3" style="width: 32px; height: 32px" />
        ...
        <li class="mb-4 border-bottom-1 surface-border py-3 flex flex-column md:flex-row md:align-items-center md:justify-content-between">
            <div class="inline-flex align-items-center">
                <img src="assets/images/blocks/logos/opera.svg" class="mr-3" style="width: 32px; height: 32px" />
                <span class="text-900 font-medium">Opera</span>
            </div>
            <div class="flex align-items-center mt-3 md:mt-3">
                <span class="text-900 font-medium mr-3 text-xl">%10</span>
                <p-knob [ngModel]="70" [readonly]="true" size="50" valueColor="darkslateblue" [showValue]="false"></p-knob>
            </div>
        </li>
        <li class="mb-4 border-bottom-1 surface-border py-3 flex flex-column md:flex-row md:align-items-center md:justify-content-between">
            <div class="inline-flex align-items-center">
                <img src="assets/images/blocks/logos/edge.svg" class="mr-3" style="width: 32px; height: 32px" />
