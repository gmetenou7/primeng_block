    ...
    <div class="flex flex-wrap shadow-2">
        ...
        <div class="w-full lg:w-6 p-4 lg:p-7 surface-card">
            <div class="flex align-items-center justify-content-between mb-7">
                ...
                <span class="text-center text-600">
                    Don't have an account? <a tabindex="0" class="font-medium text-blue-500">Sign up</a>
                </span>
            </div>
            <div class="flex justify-content-between">
                <button pButton class="p-button-help mr-2 w-6 font-medium" label="Sign In With QR"></button>
                <button pButton class="p-button-success ml-2 w-6 font-medium" label="Sign In With SMS"></button>
            </div>
            ...
            <input id="email4" type="text" pInputText class="w-full mb-3">

            <label for="password4" class="block text-900 font-medium mb-2">Password</label>
            <input id="password4" type="password" pInputText class="w-full mb-3">
