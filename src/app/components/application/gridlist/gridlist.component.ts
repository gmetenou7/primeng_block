        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$9.66</span>
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$12.45</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-600 font-medium mb-3">Eveniet magnam blanditiis</span>
                    <span class="text-2xl text-800 block mb-2 font-semibold">$21.50</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$15.00</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$44.50</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$5.90</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$21.90</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
        ...
        <div class="col-12 md:col-6 xl:col-3 p-3">
            <div class="surface-card shadow-2 border-rounded p-4">
                <div class="flex flex-column align-items-center border-bottom-1 surface-border pb-3">
                    ...
                    <span class="text-2xl text-800 block mb-2 font-semibold">$18.50</span>
                    <p-rating [ngModel]="3" readonly="true" stars="5" [cancel]="false"></p-rating>
                </div>
                <div class="flex pt-3">
                    <div class="w-6 pr-2">
