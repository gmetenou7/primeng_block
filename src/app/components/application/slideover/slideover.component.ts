...
<div class="surface-overlay flex flex-column p-4 h-full fixed top-0 right-0 shadow-2 
    ...
    <div class="pt-3 border-top-1 surface-border mt-3 flex">
        <button pButton pRipple icon="pi pi-times" class="p-button-text mr-2 flex-auto" label="Cancel" pStyleClass="@grandparent" toggleClass="translate-x-100"></button>
        <button pButton pRipple icon="pi pi-check" class="ml-2 flex-auto" label="Save" pStyleClass="@grandparent" toggleClass="translate-x-100"></button>
    </div>
</div>`;

    block6 = `
<button pButton pRipple label="Display" icon="pi pi-arrow-left" pStyleClass="@next" toggleClass="translate-x-100" [hideOnOutsideClick]="true"></button>
<div class="surface-overlay flex flex-column h-full fixed top-0 right-0 shadow-2 
...
<div class="surface-overlay flex flex-column p-4 h-full fixed top-0 right-0 shadow-2 
    ...
    block8 = `
<button pButton pRipple label="Display" icon="pi pi-arrow-right" pStyleClass="@next" toggleClass="-translate-x-100" [hideOnOutsideClick]="true"></button>
<div class="surface-overlay flex flex-column h-full fixed top-0 left-0 shadow-2 
    -translate-x-100 transition-transform transition-duration-150 transition-ease-in-out w-18rem">
