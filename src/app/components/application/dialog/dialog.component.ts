...
<p-dialog [(visible)]="visible7" [modal]="false" [closable]="false" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{width: '45vw'}">
    <section class="flex flex-column w-full mt-4">
        ...
        <div class="flex justify-content-between w-full align-items-center border-1 p-3 border-round surface-border mb-2 cursor-pointer" [ngClass]="{'bg-primary-50': payment === 'Visa'}" (click)="payment = 'Visa'">
            <div>
        ...
        <div class="flex justify-content-between w-full align-items-center border-1 p-3 border-round surface-border mb-2 cursor-pointer" [ngClass]="{'bg-primary-50': payment === 'MasterCard'}" (click)="payment = 'MasterCard'">
            <div>
                <div class="flex align-items-center mb-3">
