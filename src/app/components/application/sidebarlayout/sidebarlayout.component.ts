...
<div class="min-h-screen flex surface-ground">
    ...
    <div class="min-h-screen flex flex-column relative flex-auto">
        <div class="flex justify-content-between align-items-center px-5 surface-section shadow-2 relative lg:static border-bottom-1 surface-border" style="height:60px">
            <div class="flex">
                <a class="cursor-pointer block lg:hidden text-700 mr-3" pStyleClass="#app-sidebar-6" enterClass="hidden" enterActiveClass="fadeinleft" leaveToClass="hidden" leaveActiveClass="fadeoutleft" [hideOnOutsideClick]="true">
                    <i class="pi pi-bars text-4xl"></i>
                </a>
            </div>
            <a class="cursor-pointer block lg:hidden text-700" pStyleClass="@next" enterClass="hidden" enterActiveClass="fadein" leaveToClass="hidden" leaveActiveClass="fadeout" [hideOnOutsideClick]="true">
    ...
    <div id="app-sidebar-7" class="h-screen hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-1 border-right-1 select-none animation-duration-300 animation-ease-in-out bg-white-alpha-50" style="width:280px; border-color: rgba(255,255,255,.3);backdrop-filter: blur(10px);">
        <div class="flex flex-column h-full">
            ...
            <div class="overflow-y-auto">
                ...
                <ul class="list-none p-3 m-0">
                    <li>
                        <div class="p-3 flex align-items-center justify-content-between text-gray-700 cursor-pointer" pStyleClass="@next" enterClass="hidden" enterActiveClass="slidedown" leaveToClass="hidden" leaveActiveClass="slideup">
                            <span class="font-medium">APPLICATION</span>
                            <i class="pi pi-chevron-down"></i>
                        </div>
                        <ul class="list-none p-0 m-0 overflow-hidden">
            ...
            <div class="mt-auto border-top-1" style="border-color: rgba(255,255,255,.4)">
                <ul class="list-none p-2 m-0 hidden origin-bottom animation-duration-150 overflow-hidden animation-ease-in-out">
                    <li>
    ...
    <div class="min-h-screen flex flex-column relative flex-auto">
        <div class="flex justify-content-between align-items-center px-5 border-bottom-1 relative lg:static bg-white-alpha-50" style="height:60px; border-color: rgba(255,255,255,.4)">
            ...
            <ul class="list-none p-0 m-0 hidden lg:flex lg:align-items-center select-none lg:flex-row right-0 top-100 z-1 shadow-2 lg:shadow-none absolute lg:static px-3 py-3 lg:py-0 mr-3 lg:mr-0" style="backdrop-filter: blur(10px)">
                ...
                <li class="border-top-1 lg:border-top-none lg:mt-0 mt-2 lg:pt-0 pt-2" style="border-color: rgba(255,255,255,.4)">
...
<div class="min-h-screen flex relative lg:static" style="background-image: linear-gradient(60deg, #29323c 0%, #485563 100%);">
    <div id="app-sidebar-8" class="h-screen hidden lg:block flex-shrink-0 fixed lg:sticky left-0 top-0 z-1 border-right-1 select-none animation-duration-300 animation-ease-in-out" style="width:280px; border-color: rgba(255,255,255,.1); background-image: linear-gradient(60deg, #29323c 0%, #2f3844 100%);">
        <div class="flex flex-column h-full">
            ...
            <div class="overflow-y-auto">
                <ul class="list-none p-3 m-0">
                    <li>
                        <div class="p-3 flex align-items-center justify-content-between text-gray-500 cursor-pointer" pStyleClass="@next" enterClass="hidden" enterActiveClass="slidedown" leaveToClass="hidden" leaveActiveClass="slideup">
                            <span class="font-medium">FAVORITES</span>
                            <i class="pi pi-chevron-down"></i>
                        </div>
                        <ul class="list-none p-0 m-0 overflow-hidden">
            ...
            <div class="mt-auto border-top-1" style="border-color: rgba(255,255,255,.1)">
                <ul class="list-none p-2 m-0 hidden origin-bottom animation-duration-150 overflow-hidden animation-ease-in-out">
                    <li>
    ...
    <div class="min-h-screen flex flex-column relative flex-auto">
        <div class="flex justify-content-between align-items-center px-5 border-bottom-1 relative lg:static" style="height:60px; border-color: rgba(255,255,255,.1)">
            <div class="flex">
                <a class="cursor-pointer block lg:hidden text-gray-300 mr-3" pStyleClass="#app-sidebar-8" enterClass="hidden" enterActiveClass="fadeinleft" leaveToClass="hidden" leaveActiveClass="fadeoutleft" [hideOnOutsideClick]="true">
                    <i class="pi pi-bars text-4xl"></i>
                </a>
            </div>
            <a class="cursor-pointer block lg:hidden text-gray-300" pStyleClass="@next" enterClass="hidden" enterActiveClass="fadein" leaveToClass="hidden" leaveActiveClass="fadeout" [hideOnOutsideClick]="true">
                <i class="pi pi-ellipsis-v text-2xl"></i>
            </a>
            <ul class="list-none p-0 m-0 hidden lg:flex lg:align-items-center select-none lg:flex-row right-0 top-100 z-1 shadow-2 lg:shadow-none absolute lg:static px-3 py-3 lg:py-0 mr-3 lg:mr-0" style="background-image: linear-gradient(60deg, #29323c 0%, #485563 100%); border-radius: 30px">
                ...
                <li class="border-top-1 lg:border-top-none lg:mt-0 mt-2 lg:pt-0 pt-2" style="border-color: rgba(255,255,255,.1)">
        ...
        <div class="p-5 flex flex-column flex-auto">
            <div class="border-2 border-dashed border-round flex-auto" style="border-color: rgba(255,255,255,.1)">
...
<div class="min-h-screen flex surface-ground">
    ...
    <div class="min-h-screen flex flex-column relative flex-auto">
        <div class="flex align-items-center justify-content-between lg:justify-content-start px-5 relative lg:static" style="height:60px">
            <a class="cursor-pointer block lg:hidden text-700 mr-3" pStyleClass="#app-sidebar-10" enterClass="hidden" enterActiveClass="fadeinleft" leaveToClass="hidden" leaveActiveClass="fadeoutleft" [hideOnOutsideClick]="true">
                <i class="pi pi-bars text-4xl"></i>
            </a>
            <a class="cursor-pointer block lg:hidden text-700" pStyleClass="@next" enterClass="hidden" enterActiveClass="fadein" leaveToClass="hidden" leaveActiveClass="fadeout" [hideOnOutsideClick]="true">
                <i class="pi pi-ellipsis-v text-2xl"></i>
...
<div class="min-h-screen flex surface-ground">
    ...
    <div class="min-h-screen flex flex-column relative flex-auto">
        <div class="flex justify-content-between align-items-center px-5 surface-0 border-bottom-1 surface-border relative lg:static" style="height:60px">
            <a class="cursor-pointer block lg:hidden text-700 mr-3" pStyleClass="#app-sidebar-11" enterClass="hidden" enterActiveClass="fadeinleft" leaveToClass="hidden" leaveActiveClass="fadeoutleft" [hideOnOutsideClick]="true">
                <i class="pi pi-bars text-4xl"></i>
            </a>
            <a class="cursor-pointer block lg:hidden text-700" pStyleClass="@next" enterClass="hidden" enterActiveClass="fadein" leaveToClass="hidden" leaveActiveClass="fadeout" [hideOnOutsideClick]="true">
                <i class="pi pi-ellipsis-v text-2xl"></i>
        ...
        <div id="app-sidebar-12" class="surface-card hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-1 select-none shadow-2" style="width:280px;border-radius: 12px">
            <div class="flex flex-column h-full">
                ...
                <div class="mt-auto border-top-1 surface-border p-3 flex justify-content-between">
                    ...
                    <a class="cursor-pointer inline-flex align-items-center justify-content-center border-2 surface-border hover:surface-100 text-600 transition-colors transition-duration-150 border-circle" style="width:40px;height:40px">
                        <i class="pi pi-star-o text-xl"></i>
                    </a>
                    <a class="cursor-pointer inline-flex align-items-center justify-content-center border-2 surface-border hover:surface-100 text-600 transition-colors transition-duration-150 border-circle" style="width:40px;height:40px">
                        <i class="pi pi-cog text-xl"></i>
                    </a>
                    <a class="cursor-pointer inline-flex align-items-center justify-content-center bg-pink-500 text-white border-2 surface-border hover:surface-100 text-600 transition-colors transition-duration-150 border-circle" style="width:40px;height:40px">
