...
<p-dialog [(visible)]="visible1" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{'width': '50vw', 'max-width': '750px'}" contentStyleClass="border-round-top p-0" appendTo="body" (onShow)="input1.focus();" (onHide)="visible1 = false;  value1 = '';">
...
<p-dialog [(visible)]="visible2" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{'width': '50vw', 'max-width': '750px'}" contentStyleClass="border-round-top p-0" appendTo="body" (onShow)="input2.focus();" (onHide)="visible2 = false; value2 = '';">
    <div class="flex w-full surface-section align-items-center justify-content-between px-1">
        <span class="p-input-icon-left w-full">
            <i class="pi pi-search text-500"></i>
...
<p-dialog [(visible)]="visible3" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{'width': '50vw', 'max-width': '750px'}" contentStyleClass="border-round-top p-0" appendTo="body" (onShow)="input3.focus();" (onHide)="visible3 = false; value3 = '';">
    <div class="flex w-full surface-section align-items-center justify-content-between px-1">
        <span class="p-input-icon-left w-full">
            <i class="pi pi-search text-500"></i>
...
<p-dialog [(visible)]="visible4" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{'width': '50vw', 'max-width': '750px'}" contentStyleClass="border-round-top p-0" appendTo="body" (onShow)="input4.focus();" (onHide)="visible4 = false; value4 = '';">
    <div class="flex w-full surface-section align-items-center justify-content-between px-1">
        <span class="p-input-icon-left w-full">
            <i class="pi pi-search text-500"></i>
...
<p-dialog [(visible)]="visible5" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{width: '750px', 'backdrop-filter': 'blur(70px)'}" styleClass="border-none bg-black-alpha-50" contentStyleClass="border-black-alpha-20 border-round p-0 bg-transparent" appendTo="body" (onShow)="input5.focus();" (onHide)="visible5 = false; value5 = 'Search menus, shortcuts, contact and more...';">
    <div class="flex w-full align-items-center justify-content-between px-1">
        <span class="p-input-icon-left w-full">
            <i class="pi pi-search text-white-alpha-80"></i>
...
<p-dialog [(visible)]="visible6" [dismissableMask]="true" [modal]="true" [showHeader]="false" [breakpoints]="{'960px': '75vw', '640px': '100vw'}" [style]="{width: '750px', 'backdrop-filter': 'blur(70px)'}" styleClass="border-none bg-black-alpha-50" contentStyleClass="border-black-alpha-20 border-round-top p-0 bg-transparent" appendTo="body" (onShow)="input6.focus();" (onHide)="visible6 = false; value6 = 'Sign';">
    <div class="flex w-full align-items-center justify-content-between px-1">
        <span class="p-input-icon-left w-full">
            <i class="pi pi-search text-white-alpha-80"></i>
