...
<div class="surface-section px-4 py-5 md:px-6 lg:px-8">
    ...
    <div class="flex flex-column lg:flex-row lg:align-items-center">
        ...
        <div class="mt-3 lg:mt-0 flex align-items-start flex-column md:flex-row">
            <span class="inline-flex cursor-pointer py-2 px-3 align-items-center bg-bluegray-100 hover:bg-bluegray-200 transition-colors transition-duration-150 mb-3 md:mb-0 mr-0 md:mr-3" 
                style="border-radius: 20px" (click)="menu8_1.toggle($event)">
                Specialties <i class="ml-2 pi pi-angle-down text-bluegray-700"></i>
            </span>
            <p-menu #menu8_1 [popup]="true" [model]="items1"></p-menu>
            <span class="inline-flex cursor-pointer  py-2 px-3 align-items-center bg-bluegray-100 hover:bg-bluegray-200 transition-colors transition-duration-150 mb-3 md:mb-0 mr-0 md:mr-3" 
                style="border-radius: 20px" (click)="menu8_2.toggle($event)">
                Locations <i class="ml-2 pi pi-angle-down text-bluegray-700"></i>
            </span>
            <p-menu #menu8_2 [popup]="true" [model]="items2"></p-menu>
            <span class="inline-flex cursor-pointer  py-2 px-3 align-items-center bg-bluegray-100 hover:bg-bluegray-200 transition-colors transition-duration-150 mb-3 md:mb-0 mr-0 md:mr-3" 
                style="border-radius: 20px" (click)="menu8_3.toggle($event)">
                Contract <i class="ml-2 pi pi-angle-down text-bluegray-700"></i>
            </span>
