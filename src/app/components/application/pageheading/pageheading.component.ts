...
<div class="surface-50 px-4 py-5 md:px-6 lg:px-8 ">
        <div class="surface-card shadow-2 border-round-xl p-5">
            <div class="flex flex-column lg:justify-content-between align-items-center lg:flex-row">
            ...
            <ul
                class="list-none surface-100 flex flex-column lg:flex-row overflow-y-hidden overflow-x-auto border-round p-3">
                <li
                    class="col-12 lg:col-4 relative flex flex-column justify-content-center border-bottom-1 lg:border-bottom-none lg:border-right-1 p-3 surface-border">
