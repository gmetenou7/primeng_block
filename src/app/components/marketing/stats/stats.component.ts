...
<div class="bg-gray-900 px-4 py-8 md:px-6 lg:px-8">
    ...
    block6 = `
<div class="relative surface-section">
    <div class="text-center bg-no-repeat bg-cover bg-gray-900 px-6 py-8">
        <div class="text-blue-300 text-lg font-semibold mb-1">Why Bastion</div>
        <span class="text-white font-semibold text-4xl mt-0 line-height-3">Build secure onboarding and authentication</span>
    ...
    <div class="px-4 py-5 md:px-6 lg:px-8">
      <div class="flex flex-column lg:flex-row lg:align-items-center lg:justify-content-between">
        <div class="px-2 w-full py-6 md:px-4 lg:px-6 bg-cover relative" style="background: url(assets/images/blocks/stats/stats-1.png); background-position: center;margin-top:-2rem; top:-70px;">
          <div class="flex flex-column lg:flex-row">
              <div class="w-full p-2 mr-0 lg:mr-3 lg:mb-0 mb-3 text-center" style="background: rgba(255, 255, 255, 0.25);border-radius: 6px;">
                  <div class="text-white text-6xl line-height-3 font-medium mt-3">1 min</div>
                  <span class="text-white line-height-3 text-xl mt-0">Save Time</span>
                  <p class="text-white line-height-3 text-base font-light text-sm mt-0">Get up and run in no time.</p>
              </div>
              <div class="w-full p-2 mr-0 lg:mr-3 lg:mb-0 mb-3 text-center" style="background: rgba(255, 255, 255, 0.25);border-radius: 6px;backdrop-filter: blur(10px);">
                <div class="text-white text-6xl line-height-3 font-medium mt-3">+200%</div>
                <span class="text-white line-height-3 text-xl mt-0">Conversion Rate</span>
                <p class="text-white line-height-3 text-base font-light text-sm mt-0">Increase rate after switch to Bastion</p>
              </div>
              <div class="w-full p-2 mr-0 lg:mr-3 lg:mb-0 mb-3 text-center" style="background: rgba(255, 255, 255, 0.25);border-radius: 6px;backdrop-filter: blur(10px);">
                <div class="text-white text-6xl line-height-3 font-medium mt-3">+300K</div>
                <span class="text-white line-height-3 text-xl mt-0">Popular Community</span>
                <p class="text-white line-height-3 text-base font-light text-sm mt-0">You will never walk alone.</p>
            </div>
          </div>
        </div>
      </div>
