    ...
    <div class="flex flex-wrap">
        <div class="w-full xl:w-6 pr-0 xl:pr-6">
            ...
            <div class="flex align-items-center mt-4">
                ...
                <span class="text-900 font-medium text-xl white-space-nowrap">Darrel Steward</span>
                <span class="text-500 font-medium text-xl mx-3">|</span>
                <span class="text-500 font-medium text-xl white-space-nowrap">Oct 7</span>
            </div>
            <div class="text-900 font-bold text-4xl mt-4">Circumpolar Cooperation</div>
        ...
        <div class="w-full xl:w-6">
            <div class="flex flex-wrap align-items-start mb-8 mt-8 xl:mb-6 xl:mt-0">
                ...
                <div class="w-full xl:w-6">
                    <div class="flex align-items-center">
                        ...
                        <span class="text-900 font-medium text-xl white-space-nowrap">Bessie Cooper</span>
                        <span class="text-500 font-medium text-xl mx-3">|</span>
                        <span class="text-500 font-medium text-xl white-space-nowrap">Oct 7</span>
                    </div>
                    <div class="text-900 font-bold text-4xl mt-4">World Famous Fish</div>
            ...
            <div class="flex flex-wrap align-items-start">
                ...
                <div class="w-full xl:w-6">
                    <div class="flex align-items-center">
                        <img src="assets/images/blocks/avatars/circle/avatar-f-3.png" class="mr-3 flex-shrink-0" width="28" height="28"/>
                        <span class="text-900 font-medium text-xl white-space-nowrap">Jenna Clark</span>
                        <span class="text-500 font-medium text-xl mx-3">|</span>
                        <span class="text-500 font-medium text-xl white-space-nowrap">Oct 10</span>
                    </div>
                    <div class="text-900 font-bold text-4xl mt-4">Extinction and Origination</div>
        ...
        <div class="col-12 lg:col-6 pr-0 lg:pr-4 mb-6 lg:mb-0">
            <div style="min-height:350px; background: url('assets/images/blocks/blog/blog-12.jpg') no-repeat; background-size: cover" class="mb-6 p-3 flex flex-column justify-content-between">
                ...
                <div>
                    ...
                    <p class="text-200 line-height-3 mt-0 mb-3">Bibendum ut tristique et egestas. Massa tincidunt nunc pulvinar sapien et ligula ullamcorper malesuada proin.</p>
                    <span class="text-300 font-medium">4 days ago</span>
                </div>
            </div>
        ...
        <div class="col-12 lg:col-6 pl-2 lg:pl-4">
            ...
            <div style="min-height:350px; background: url('assets/images/blocks/blog/blog-13.jpg') no-repeat; background-size: cover" class="p-3 flex flex-column justify-content-between">
                ...
                <div>
                    ...
                    <p class="text-200 line-height-3 mt-0 mb-3">Adipiscing diam donec adipiscing tristique risus nec feugiat in fermentum. Sed ullamcorper morbi tincidunt ornare massa eget egestas purus.</p>
                    <span class="text-300 font-medium">4 days ago</span>
                </div>
            </div>
        </div>
