...
<div class="bg-indigo-500 px-4 py-8 md:px-6 lg:px-8">
    ...
    block6: string = `
<section class="surface-section flex flex-column justify-content-center align-items-center gap-3 px-4 py-8 md:px-6 lg:px-8">
    <h2 class="m-0 font-normal text-xl text-700 line-height-3">Trusted by Fortune 500 companies</h2>
