...
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    ...
    block6: string = `
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div class="text-center font-semibold text-blue-500 text-lg mb-2">Who Are We</div>
      <div class="text-center font-semibold text-2xl line-height-3 text-900 mb-2">Meet The Team Behind Bastion</div>
        <div class="text-center text-sm line-height-3 text-600 mb-4">Faucibus ornare suspendisse sed nisi. Nisl rhoncus mattis rhoncus urna neque viverra justo nec.</div>
         <div class="grid">
           <div class="col-12 md:col-6 lg:col-3 p-3">
              <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                  <img src="assets/images/blocks/team/team-9.png" class="w-full block" />
                  <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                      <div class="flex flex-column p-5 h-full">
                          <span class="block font-light text-white line-height-3 text-2xl">Mysha Feeney</span>
                          <span class="font-normal text-base line-height-3 text-xs text-300 mb-3">Scrum Master</span>
                          <div class="mt-auto">
                              <a class="cursor-pointer text-white"><i class="pi pi-discord text-2xl mr-3"></i></a>
                              <a class="cursor-pointer text-white"><i class="pi pi-linkedin text-2xl mr-3"></i></a>
                              <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl"></i></a>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="col-12 md:col-6 lg:col-3 p-3">
            <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                <img src="assets/images/blocks/team/team-10.png" class="w-full block" />
                <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                    <div class="flex flex-column p-5 h-full">
                        <span class="block font-light text-white line-height-3 text-2xl">Helena Larsen</span>
                        <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">President of Sales</span>
                        <div class="mt-auto">
                            <a class="cursor-pointer text-white"><i class="pi pi-linkedin text-2xl mr-3"></i></a>
                            <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl"></i></a>
                        </div>
          ...
          <div class="col-12 md:col-6 lg:col-3 p-3">
              <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                  ...
                  <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                      <div class="flex flex-column p-5 h-full">
                          <span class="block font-light text-white line-height-3 text-2xl">Brian Bargeman</span>
                          <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">Team Leader</span>
                          <div class="mt-auto">
                              <a class="cursor-pointer text-white"><i class="pi pi-linkedin text-2xl mr-3"></i></a>
                              <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl"></i></a>
                          </div>
          ...
          <div class="col-12 md:col-6 lg:col-3 p-3">
            <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                  <img src="assets/images/blocks/team/team-12.png" class="w-full block" />
                  <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                      <div class="flex flex-column p-5 h-full">
                          <span class="block font-light text-white line-height-3 text-2xl">Ronald Richards</span>
                          <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">Software Development Manager</span>
                          <div class="mt-auto">
                              <a class="cursor-pointer text-white"><i class="pi pi-github text-2xl mr-3"></i></a>
                              <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl"></i></a>
                          </div>
                      </div>
                  </div>
      ...
      <div class="grid">
        <div class="col-12 md:col-6 lg:col-3 p-3">
          <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                <img src="assets/images/blocks/team/team-13.png" class="w-full block" />
                <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                    <div class="flex flex-column p-5 h-full">
                        <span class="block font-light text-white line-height-3 text-2xl">Albert Flores</span>
                        <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">Web Designer</span>
                        <div class="mt-auto">
                            <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl mr-3"></i></a>
                            <a class="cursor-pointer text-white"><i class="pi pi-github text-2xl mr-3"></i></a>
                            <a class="cursor-pointer text-white"><i class="pi pi-discord text-2xl mr-3"></i></a>
        ...
        <div class="col-12 md:col-6 lg:col-3 p-3">
          <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                <img src="assets/images/blocks/team/team-14.png" class="w-full block" />
                <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                  <div class="flex flex-column p-5 h-full">
                      <span class="block font-light text-white line-height-3 text-2xl">Leona Gunn</span>
                      <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">Software Developer</span>
                      <div class="mt-auto">
                          <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-github text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-discord text-2xl mr-3"></i></a>
        ...
        <div class="col-12 md:col-6 lg:col-3 p-3">
          <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                <img src="assets/images/blocks/team/team-15.png" class="w-full block" />
                <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                  <div class="flex flex-column p-5 h-full">
                      <span class="block font-light text-white line-height-3 text-2xl">David Goodman</span>
                      <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">UI/UX Designer</span>
                      <div class="mt-auto">
                          <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-github text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-discord text-2xl"></i></a>
                      </div>
                  </div>
              </div>
            </div>
        ...
        <div class="col-12 md:col-6 lg:col-3 p-3">
          <div class="relative overflow-hidden flex justify-content-center" style="border-radius: 6px">
                <img src="assets/images/blocks/team/team-16.png" class="w-full block" />
                <div class="absolute bottom-0 left-0 right-0 select-none m-3 border-round-lg shadow-6" style="left: 0.5rem; right: 0.5rem;background-color: rgba(255, 255, 255, 0.2); backdrop-filter: blur(8px);">
                  <div class="flex flex-column p-5 h-full">
                      <span class="block font-light text-white line-height-3 text-2xl">Aleena Jones</span>
                      <span class="font-normal text-base line-height-3 text-xs text-300 pb-3">Software Tester</span>
                      <div class="mt-auto">
                          <a class="cursor-pointer text-white"><i class="pi pi-twitter text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-github text-2xl mr-3"></i></a>
                          <a class="cursor-pointer text-white"><i class="pi pi-discord text-2xl mr-3"></i></a>
