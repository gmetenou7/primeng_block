...
<section class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <h2 class="text-center text-blue-500 font-semibold text-2xl line-height-1">Who Are We</h2>
    <h3 class="text-center text-900 font-semibold text-5xl line-height-1">Meet The Team Behind Bastion</h3>
    <p class="text-center text-600 font-normal text-xl line-height-1">Faucibus ornare suspendisse sed nisi. Nisl rhoncus mattis rhoncus urna neque viverra justo nec.</p>
    <div class="grid grid-nogutter align-items-center">
        <div class="col-12">
            <div class="grid mt-4">
                <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
