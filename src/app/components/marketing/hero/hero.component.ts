    ...
    <div class="flex flex-wrap">
        <div class="w-full xl:w-6 p-3 pr-5">
            ...
            <div class="relative w-full xl:w-30rem">
                ...
                <button class="p-3 absolute appearance-none p-component border-none bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 text-white outline-none h-full" style="border-radius: 30px; top: 0; right: 0">Join Now</button>
            </div>
        </div>
