...
<section style="background-image: url('assets/images/blocks/hero/hero-11.png');" class="bg-cover z-1">
    <div class="p-6 flex flex-column align-items-center relative overflow-hidden bg-no-repeat bg-cover" style="background:rgba(233, 244, 255, 0.7);">
        <article class="flex flex-column align-items-center bg-no-repeat z-2">
            <span class="text-center font-semibold text-xs md:text-sm text-black-alpha-60 mb-2">MULTIPLY YOUR DEVELOPING SPEED</span>
            <h3 class="text-center font-bold text-3xl md:text-6xl text-black-alpha-80 mt-0 mb-4">Start your business with <br/> <span style="background: linear-gradient(90deg, rgba(0, 209, 255, 1) 0%, rgba(255, 109, 232, 1) 100%); background-clip: text; -webkit-text-fill-color: transparent;">PrimeBlocks</span></h3>
            <div class="px-3 py-2 border-round-lg surface-section flex justify-content-between w-20rem shadow-1">
                <span class="font-normal text-600">npm i primeblocks</span>
                <span class="flex justify-content-center border-round shadow-1 cursor-pointer p-1"><i class="pi pi-copy"></i></span>
            </div>
        </article>
