...
<div class="surface-section px-4 py-2 md:px-6 lg:px-8  ">
    <div class="surface-section px-4 py-2 md:px-6 lg:px-8  ">
       <div class="text-center px-6 py-8">
           ...
           <p class="font-normal text-700 text-xl mt-0 mb-0 line-height-3">Orci dapibus ultrices in iaculis. Quam adipiscing vitae proin sagittis nisl. 
               Amet massa vitae tortor condimentum lacinia quis vel eros donec.</p>
       </div>
    <div class="grid mb-4">
        <div class="col-12 md:col-4 mb-2 px-5">
            <span class="p-3 shadow-2 mb-3 inline-block  bg-blue-500 text-0" style="border-radius: 10px">
                <i class="pi pi-map text-4xl text-pr-500"></i>
            </span>
            <div class="text-blue-500 mb-3 font-medium text-base">Dynamic Mapping</div>
            <div class="text-900 mb-3 font-medium text-xl">Collect and organize mappings</div>
            <span class="text-base font-normal text-600 line-height-3">Diam sollicitudin tempor id eu. Ut consequat
        ...
        <div class="col-12 md:col-4 mb-4 px-5">
            <span class="p-3 shadow-2 mb-3 inline-block  bg-bluegray-400 text-0" style="border-radius: 10px">
                <i class="pi pi-sync text-4xl text-pr-500"></i>
            </span>
            ...
            <span class="text-base font-normal text-600 line-height-3">Massa id neque aliquam vestibulum. Tristique
        ...
        <div class="col-12 md:col-4 mb-4 px-5">
            <span class="p-3 shadow-2 mb-3 inline-block  bg-bluegray-400 text-0" style="border-radius: 10px">
                <i class="pi pi-shield text-4xl text-pr-500"></i>
            </span>
            ...
            <span class="text-base font-normal text-600 line-height-3">Pellentesque eu tincidunt tortor aliquam nulla.
