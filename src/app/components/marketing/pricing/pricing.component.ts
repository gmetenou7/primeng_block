...
<div class="surface-50 relative flex flex-column overflow-hidden justify-content-center align-items-center gap-6 px-4 py-8 md:px-6 lg:px-8">
    <header class="flex align-items-center justify-content-center flex-column gap-2">
        ...
        <span class="text-xl line-height-3 text-700">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit
            numquam eligendi quos.</span>
        ...
        <div class="flex flex-column gap-4 p-4 surface-0 border-round-lg shadow-2">
            <div class="flex justify-content-between align-items-center border-bottom-1 surface-border pb-4 gap-5">
                <div class="flex flex-column gap-2">
                    ...
                    <span class="text-base text-600">Proin fermentum leo vel orci porta non.</span>
                </div>
