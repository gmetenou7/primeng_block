...
<div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
    ...
    block7: string = `
<div class="surface-50 relative flex flex-column overflow-hidden justify-content-center align-items-center gap-6 px-4 py-8 md:px-6 lg:px-8">
    <header class="flex align-items-center justify-content-center flex-column gap-2">
        ...
        <h1 class="m-0 font-bold text-4xl line-height-3 text-900">Find your perfect plan</h1>
        <span class="text-xl line-height-3 text-700">Fringilla ut morbi tincidunt augue interdum velit euismod. Non arcu risus quis varius quam.</span>
        <div class="flex gap-2 align-items-center mt-4">
            <p-inputSwitch class="flex" id="switchTiers"></p-inputSwitch>
            <label for="#switchTiers" class="font-medium text-base line-height-3 text-900">Switch to Annual
                Plans</label>
        </div>
    </header>

    <div class="flex flex-column lg:flex-row z-1 justify-content-center gap-5">
        <div class="flex flex-column gap-4 p-4 surface-0 border-round-lg shadow-2">
            ...
            <div class="flex flex-column gap-3 border-bottom-1 surface-border pb-4">
                <h3 class="m-0 mb-2">Started Plan Includes:</h3>
                <div class="flex justify-content-between align-items-center">
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Proin fermentum leo</span>
                    </span>
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Faucibus vitae aliquet nec</span>
                    </span>
                </div>
                <div class="flex justify-content-between align-items-center">
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Ullamcorper morbi tincidunt</span>
                    </span>
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Tristique senectus et netus</span>
                    </span>
                </div>
                <div class="flex justify-content-between align-items-center">
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Adipiscing enim eu turpis</span>
                    </span>
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Elit sed vulputate mi sit</span>
                    </span>
                </div>
                <div class="flex justify-content-between align-items-center">
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Velit ut tortor pretium</span>
                    </span>
                    <span class="flex align-items-center gap-2">
                        <i class="pi pi-check-circle text-green-500"></i>
                        <span class="text-base text-600">Et netus et malesuada</span>
                    </span>
                </div>
            </div>
            <div>
