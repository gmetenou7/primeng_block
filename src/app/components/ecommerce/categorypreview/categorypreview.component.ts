...
export class CategoryPreviewComponent {
    ...
    block4: string = `
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="flex flex-column lg:flex-row align-items-center justify-content-center lg:justify-content-between mb-5 lg:mb-3">
        ...
        <div class="grid -mt-3 -ml-3 -mr-3 flex-wrap">
            <div class="col text-center px-4 mt-4 md:mt-0 h-25rem cursor-pointer">
                <div class="flex h-full bg-no-repeat bg-cover border-round shadow-2 mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-12.jpg); min-width: 15rem;">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-4 mt-4 md:mt-0 h-25rem cursor-pointer">
                <div class="flex h-full bg-no-repeat bg-cover border-round shadow-2 mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-13.jpg); min-width: 15rem;">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-4 mt-4 md:mt-0 h-25rem cursor-pointer">
                <div class="flex h-full bg-no-repeat bg-cover border-round shadow-2 mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-14.jpg); min-width: 15rem;">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-4 mt-4 md:mt-0 h-25rem cursor-pointer">
                <div class="flex h-full bg-no-repeat bg-cover border-round shadow-2 mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-15.jpg); min-width: 15rem;">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-4 mt-4 md:mt-0 h-25rem cursor-pointer">
                <div class="flex h-full bg-no-repeat bg-cover border-round shadow-2 mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-16.jpg); min-width: 15rem;">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
        </div>
    ...
    <div class="surface-50 px-4 py-8 md:px-6 lg:px-8">
        <div class="bg-no-repeat bg-cover border-round shadow-2 h-20rem w-full" style="background:linear-gradient(90deg, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-17.jpg);">
            <div class="h-full w-full p-6">
                ...
                <a pRipple tabindex="0" class="bg-primary inline-block mt-5 text-2xl font-normal px-3 py-2 border-round cursor-pointer">View the Collection</a>
            </div>
        </div>
    </div>`;
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="grid">
            ...
            <div class="col-6 lg:col-2 flex flex-column align-items-center mx-auto lg:mx-0 mb-3 md:mb-0">
