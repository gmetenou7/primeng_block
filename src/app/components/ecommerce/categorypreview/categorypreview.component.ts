...
export class CategoryPreviewComponent implements OnInit {
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        ...
        <div class="grid -mt-3 -ml-3 -mr-3 flex-wrap">
            <div class="col flex px-3 flex-column sm:mt-4 lg:mt-0">
                <img src="assets/images/blocks/ecommerce/categorypreview/category-preview-1-1.png" class="w-full h-full" alt="product">
                <p class="text-600 uppercase text-base font-medium my-3">Subtitle</p>
                <a tabindex="0" class="text-xl cursor-pointer text-900 flex align-items-center hover:text-blue-500 transition-duration-150">Category Title <i class="pi pi-fw pi-arrow-right ml-2 text-xl"></i></a>
            </div>
            <div class="col flex px-3 flex-column sm:mt-4 lg:mt-0">
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        ...
        <div class="grid -mt-3 -ml-3 -mr-3 sm:flex-column align-items-center lg:flex-row">
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="grid grid-nogutter -mt-3 -ml-3 -mr-3">
            <div class="sm:col-12 lg:col-6 p-3">
                <div class="flex flex-column justify-content-between h-full w-full border-round bg-no-repeat bg-cover" style="background: linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-9.png); min-height:50rem;">
                    ...
                    <div class="p-4 align-self-end">
                        <a tabindex="0" class="text-2xl cursor-pointer text-white flex align-items-center hover:text-blue-500 transition-duration-150">Shop Now<i class="pi pi-fw pi-arrow-right text-2xl ml-2"></i></a>
                    </div>
                </div>
            </div>
    ...
    block4: string = `
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="flex flex-column md:flex-row align-items-center md:justify-content-between mb-5 lg:mb-3">
            <div class="text-900 font-medium text-4xl mb-4">Top Categories</div>
            <a tabindex="0" class="text-base cursor-pointer text-blue-500 flex align-items-center">See All Categories<i class="pi pi-arrow-right text-base ml-3"></i></a>
        </div>
        <div class="grid -mt-3 -ml-3 -mr-3 flex-wrap">
            <div class="col px-3 sm:mt-4 lg:mt-0 h-23rem">
                <div class="flex w-15rem h-full bg-no-repeat bg-cover border-round shadow-2 sm:mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-12.jpg)">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-3 sm:mt-4 lg:mt-0 h-23rem">
                <div class="flex w-15rem h-full bg-no-repeat bg-cover border-round shadow-2 sm:mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-13.jpg)">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-3 sm:mt-4 lg:mt-0 h-23rem">
                <div class="flex w-15rem h-full bg-no-repeat bg-cover border-round shadow-2 sm:mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-14.jpg)">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-3 sm:mt-4 lg:mt-0 h-23rem">
                <div class="flex w-15rem h-full bg-no-repeat bg-cover border-round shadow-2 sm:mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-15.jpg)">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
            <div class="col px-3 sm:mt-4 lg:mt-0 h-23rem">
                <div class="flex w-15rem h-full bg-no-repeat bg-cover border-round shadow-2 sm:mx-auto lg:mx-0" style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.5) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-16.jpg)">
                    <p class="font-medium text-2xl text-white text-center w-full align-self-end">Category</p>
                </div>
            </div>
        </div>
    ...
    block5: string = `
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="bg-no-repeat bg-cover border-round shadow-2 h-20rem w-full" style="background:linear-gradient(90deg, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%), url(assets/images/blocks/ecommerce/categorypreview/category-preview-1-17.jpg);">
            <div class="h-full w-full p-6">
                <div class="text-blue-500 text-5xl font-bold">Category Title</div>
                <p class="text-black-alpha-80 text-3xl font-normal">Editor's Choice</p>
                <button pButton class="mt-5 text-2xl font-normal bg-blue-500 border-blue-500 text-white">View the Collection</button>
            </div>
        </div>
    </div>`;
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="grid">
            <div class="col-12 lg:col-2 text-center lg:text-left">
                ...
                <p class="text-600 font-normal text-base">Dui id ornare arcu odio ut sem nulla pharetra diam.</p>
            </div>
            <div class="col-6 lg:col-2 flex flex-column align-items-center sm:mx-auto lg:mx-0">
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="grid">
            <div class="col-12 lg:col-2 text-center lg:text-left">
                ...
                <p class="text-600 font-normal text-base mt-3">Dui id ornare arcu odio ut sem nulla pharetra diam.</p>
                <a tabindex="0" class="text-blue-500 text-base cursor-pointer block mt-5 mb-5 md:mb-0">Explore Collections</a>
            </div>
            <div class="sm:col-12 md:col-12 lg:col w-full lg:w-9 lg:ml-7 lg:-mt-4">
