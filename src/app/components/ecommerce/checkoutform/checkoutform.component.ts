      ...
      <div class="grid -mr-3 -ml-3">
          <div class="col-12 lg:col-8 p-4">
              <div class="surface-card grid formgrid p-fluid border-round shadow-2 p-4">
                  <div class="col-12 mb-4 flex align-items-center justify-content-between">
                  ...
                  <div class="col-12 flex">
                      <div class="flex justify-content-between p-3 border-round border-1 border-gray-200 surface-50 w-full mr-3 hover:border-primary" (click)="selectedValue = 'UPS'" [ngClass]="{'border-primary bg-indigo-50': selectedValue === 'UPS'}">
                      ...
                      <div class="flex justify-content-between p-3 border-round border-1 border-gray-200 surface-50 w-full hover:border-primary" (click)="selectedValue = 'FedEx'" [ngClass]="{'border-primary bg-indigo-50': selectedValue === 'FedEx'}">
                          <div class="mr-3 lg:mr-0">
                  ...
                  <div class="col-12 mb-4">
                      <div class="p-3 border-1 border-round-top border-gray-200" (click)="selectedValue2 === 'paypal'" [ngClass]="{'border-primary bg-indigo-50': selectedValue2 === 'paypal'}">
                          <p-radioButton name="paypal" value="paypal" [(ngModel)]="selectedValue2" inputId="paypal"></p-radioButton>
                          <label for="paypal" class="ml-3">PayPal</label>
                      </div>
                      <div class="p-3 border-x-1 border-gray-200" (click)="selectedValue2 === 'creditcard'" [ngClass]="{'border-1 border-primary bg-indigo-50': selectedValue2 === 'creditcard'}">
                          <p-radioButton name="creditCard" value="creditcard" [(ngModel)]="selectedValue2" inputId="creditCard"></p-radioButton>
                          <label for="creditCard" class="ml-3">Credit Card</label>
                      </div>
                      <div class="p-3 border-1 border-round-bottom border-gray-200" (click)="selectedValue2 === 'bank'" [ngClass]="{'border-primary bg-indigo-50': selectedValue2 === 'bank'}">
                          <p-radioButton name="bank" value="bank" [(ngModel)]="selectedValue2" inputId="bank"></p-radioButton>
                          <label for="bank" class="ml-3">Online Bank Transfer</label>
                      </div>
                  </div>
                  <div class="col-12 field mb-0">
                      ...
                      <span class="p-input-icon-right w-full">
                          ...
                          <input type="text" class="p-inputtext w-full mb-3" placeholder="1234 5678 9123 4567"/>
                      </span>                    
                  </div>
                  <div class="col-12 lg:col-6 field mb-0">
                      <label for="expiry" class="text-900 font-medium mb-3">Expiry Date</label>
                      <p-calendar inputId="expiry" [(ngModel)]="date1" class="mb-3" placeholder="MM/YY"></p-calendar>                
                  </div>
          ...
          <div class="col-12 lg:col-4 p-4">
              <div class="surface-card border-round shadow-2 p-5">
                  <div class="flex justify-content-between align-items-center border-bottom-1 pb-3 border-gray-200">
                      <span class="text-900 font-medium text-xl"><i class="pi pi-shopping-cart text-xl mr-2"></i>Your Order (1)</span>
                      <span class="text-600 font-medium">Edit Cart</span>
                  </div>

                  <div class="flex align-items-center py-2 mt-3 border-bottom-1 border-gray-200">
    ...
    <div class="surface-section">
      <div class="grid grid-nogutter">
          <div class="col-12 lg:col-6 h-full px-4 py-8 md:px-6 lg:px-8">
              <ul class="flex list-none p-0 mb-6">
              ...
              <div class="grid formgrid">
                  ...
                  <div class="col-12 flex justify-content-end mt-6">
                      <button pButton pRipple class="p-button-text px-6" label="Return to Cart"></button>
                      <button pButton pRipple class="p-button-primary px-6" label="Continue to Shipping"></button>
                  </div>
              </div>
          </div>
          <div class="col-12 lg:col-6 px-4 py-8 md:px-6 lg:px-8 surface-50">
              ...
              <div class="flex align-items-center py-3 border-bottom-1 border-gray-200">
          ...
          <div class="col-12 lg:col-9 p-3">
              <div class="p-4 surface-card border-round shadow-2">
                      ...
                      <div class="ml-5 p-2 flex-auto">
                          <div class="mb-3">
                            ...
                            <div class="p-2 flex align-items-center">
                              <img src="assets/images/blocks/ecommerce/checkoutform/checkoutform-1-4.png" class="w-8rem h-8rem flex-shrink-0" />
                              <div class="flex-auto p-3">
                                  <div class="flex align-items-center justify-content-between mb-3">
                                      <span class="text-900 font-medium">Product Name</span>
                  ...
                  <div class="flex">
                      ...
                      <div class="ml-5 p-2 flex-auto">
                          <div class="mb-3">
                              <span class="text-900 font-medium inline-block mr-3">Payment Method</span>
                          </div>
                          <div class="grid flex-column lg:flex-row">
                              <div class="col p-3">
                                  <div class="flex flex-column border-round border-1 border-gray-200 p-4 cursor-pointer hover:border-primary transition-duration-150" (click)="selectedCard = card1" [ngClass]="{'border-primary': selectedCard === card1}">
                                      ...
                                      <span class="inline-block text-900 text-xl mt-3">**** **** **** 1234</span>
                                      <div class="flex justify-content-between align-items-center mt-3">
                                          <span class="inline-block text-600 text-sm">Cardholder Name</span>
                                          <span class="inline-block text-600 text-sm">Expiry Date</span>
                                      </div>
                                      <div class="flex justify-content-between align-items-center mt-3">
                              ...
                              <div class="col p-3">
                                  <div class="flex flex-column border-round border-1 border-gray-200 p-4 cursor-pointer hover:border-primary transition-duration-150" (click)="selectedCard = card2" [ngClass]="{'border-primary': selectedCard === card2}">
                                      <img src="assets/images/blocks/ecommerce/checkoutform/checkoutform-1-5.png" class="w-6rem" alt="Visa">
                                      <span class="inline-block text-900 text-xl mt-3">**** **** **** 1235</span>
                                      <div class="flex justify-content-between align-items-center mt-3">
                                          <span class="inline-block text-600 text-sm">Cardholder Name</span>
                                          <span class="inline-block text-600 text-sm">Expiry Date</span>
                                      </div>
