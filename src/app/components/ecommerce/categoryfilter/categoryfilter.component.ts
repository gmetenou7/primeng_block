...
export class CategoryFilterComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.selectedColors = [{name: 'Black', class:'bg-gray-500'}];
    }
    ...
    block1: string = ` 
      <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        ...
        <div class="flex sm:flex-wrap lg:flex-nowrap border-top-1 py-4 border-200">
            <div class="col-12 lg:col-2 mr-4 flex p-0 flex-column">
                <div class="flex flex-column p-0 -mt-2 border-bottom-1 border-gray-300">
                ...
                <div class="border-bottom-1 border-gray-300 mt-3">
                    ...
                    <div class="overflow-hidden transition-all transition-duration-400 transition-ease-in-out">
                        ...
                        <div class="flex w-full justify-content-between">
                            ...
                            <p-badge [value]="42" styleClass="mr-2 bg-gray-300 text-600 p-0 border-circle"></p-badge>
                        </div>
                        <div class="flex w-full justify-content-between">
                            <div class="field-checkbox">
                            ...
                            <p-badge [value]="18" styleClass="mr-2 bg-gray-300 text-600 p-0 border-circle"></p-badge>
                        </div>
                        <div class="flex w-full justify-content-between">
                            <div class="field-checkbox">
                            ...
                            <p-badge [value]="7" styleClass="mr-2 bg-gray-300 text-600 p-0 border-circle"></p-badge>
                        </div>
                        <div class="flex w-full justify-content-between">
                            <div class="field-checkbox">
                            ...
                            <p-badge [value]="36" styleClass="mr-2 bg-gray-300 text-600 p-0 border-circle"></p-badge>
                        </div>
                    ...
                    <div class="overflow-hidden transition-all transition-duration-400 transition-ease-in-out">
                        ...
                        [showThumbnails]="false" [showIndicators]="true"> 
                            <ng-template pTemplate="item" let-item>
                                <div class="flex flex-wrap w-full h-auto overflow-hidden" style="column-gap: 5px; row-gap: 5px;">
                                    <div class="w-4rem h-2rem text-900 flex justify-content-center align-items-center text-sm cursor-pointer border-round" *ngFor="let size of item.page" (click)="selectedSize = size.value;" [ngClass]="{'bg-gray-200': size.value !== selectedSize, 'bg-blue-200': size.value === selectedSize}">{{size.value}}</div>
                                </div>                           
                            </ng-template>
                        </p-galleria>
                    </div>
            ...
            <div class="w-full border-2 border-dashed border-gray-300"></div>
        </div>
      </div>`;
    ...
    block2: string = `
      ...
      <div class="grid grid-nogutter">
          <div class="col-12 mt-5 flex flex-column lg:flex-row align-items-center mb-4">
              <button pButton class="p-button-rounded bg-gray-900 mr-3 w-full lg:w-auto" label="Filters" icon="pi pi-chevron-up ml-3" iconPos="right" pStyleClass=".filter-container" enterClass="hidden" enterActiveClass="slidedown" leaveToClass="hidden" leaveActiveClass="slideup"></button>
              <div class="grid flex-column lg:flex-row w-full h-full">
                  <div class="col-10 lg:col flex flex-wrap">
                      ...
                      <a pRipple tabindex="0" class="cursor-pointer flex sm:h-3rem lg:h-auto align-items-center hover:text-blue-500 transition-duration-150" (click)="selectedFilters = []; selectedColors2 = 0;">Clear All</a>
                  </div>
              </div>
          </div>
          ...
          <div class="filter-container col-12 overflow-hidden transition-all transition-duration-400 transition-ease-in-out">
              <div class="grid grid-nogutter">
                  <div class="flex-auto lg:flex-1 col mt-4 lg:mt-2 mr-4 p-4 flex-column border-1 border-gray-300 border-round">
                  ...
                  <div class="flex-auto lg:flex-1 col mt-4 lg:mt-2 p-4 border-1 border-gray-300 border-round">
                      ...
                      [showThumbnails]="false" [showIndicators]="true"> 
                          <ng-template pTemplate="item" let-item>
                              <div class="flex flex-wrap justify-content-between w-full h-15rem overflow-hidden" style="column-gap: 5px; row-gap: 5px;">
                                  <div class="w-5rem h-3rem text-900 flex justify-content-center align-items-center text-sm cursor-pointer border-round" *ngFor="let size of item.page" (click)="selectedSize2 = size.value; selectedFilters.push(size.value)" [ngClass]="{'bg-gray-200': size.value !== selectedSize, 'bg-blue-200': size.value === selectedSize}">{{size.value}}</div>
                              </div>                           
                          </ng-template>
                      </p-galleria>
                  </div>
          ...
          <div class="col-12 border-2 border-dashed border-gray-300 h-30rem"></div>
      </div>
    </div>`;
    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
      <div class="flex justify-content-between">
          <div class="flex align-items-center">
              <div class="text-900 font-bold text-3xl">Category Title </div>
              <p-badge [value]="76" styleClass="ml-3 bg-gray-300 text-600 p-0 border-circle"></p-badge>
          </div>
      ...
      <p-divider styleClass="w-full bg-gray-300"></p-divider>
      <div class="grid grid-nogutter align-items-center">
          <p-multiSelect [options]="brands" [(ngModel)]="selectedBrands2" defaultLabel="Brand" optionLabel="name" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 w-full mr-4"></p-multiSelect>
          <p-multiSelect [options]="colors" [(ngModel)]="selectedColors" defaultLabel="Color" optionLabel="name" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 w-full mr-4">
              <ng-template let-value pTemplate="selectedColors">
                  ...
                  <div *ngIf="!selectedColors || selectedColors.length === 0">
                      Color
                  </div>
              </ng-template>
          ...
          <p-multiSelect [options]="prices" [(ngModel)]="selectedPrice" defaultLabel="Price" optionLabel="range" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 lg:col w-full mr-4"></p-multiSelect>
          ...
          <div class="col-12 border-2 border-dashed border-gray-300 h-30rem mt-2"></div>
      </div>
    </div>`;
}
