...
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="grid grid-nogutter align-items-center">
        <p-multiSelect [options]="brands" [(ngModel)]="selectedBrands2" placeholder="Brand" optionLabel="name" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 w-full mr-0 lg:mr-4 text-900"></p-multiSelect>
        <p-multiSelect [options]="colors" [(ngModel)]="selectedColors" placeholder="Color" optionLabel="name" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 w-full mr-0 lg:mr-4 text-900">
        ...
        <p-multiSelect [options]="prices" [(ngModel)]="selectedPrice2" placeholder="Price" optionLabel="range" styleClass="w-full" class="flex-auto lg:flex-1 mb-3 lg:mt-0 lg:col w-full mr-0 lg:mr-4 text-900"></p-multiSelect>
