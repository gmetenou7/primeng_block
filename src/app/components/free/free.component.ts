...
<div class="surface-0">
    ...
    block4: string = `
<div class="surface-0 text-700 text-center">
...
<div class="grid">
    ...
    block8: string = `
<div class="surface-0 p-4 shadow-2 border-round w-full lg:w-6">
...
<div class="surface-0">
    ...
    <ul class="list-none p-0 m-0">
        <li class="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
        ...
        <li class="flex align-items-center py-3 px-2 border-top-1 border-bottom-1 border-300 flex-wrap">
...
<div class="surface-0 p-4 shadow-2 border-round">
    ...
    <div style="height: 150px" class="border-2 border-dashed border-300"></div>
</div>`;
